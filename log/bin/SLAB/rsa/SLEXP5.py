...
#function to decrypt
def decryption(CT, sign, newd, n1, E,n2):
  print("Below is your Reciver Sign checking \n")
  SignM = encryption(sign, E, n2)
  M = pow(CT, newd, n1)
  if (SignM == M):
    print(SignM, " == ", M, "SIgnature is correct \n")
    DE = M % n1
...
if ch == 1:
  ...
  print("Below is your signature\n")
  sign = encryption(M, newdA, na)
  print("Below is your Ciphet Text\n")
  CT = encryption(M, Eb, nb)
  decryption(CT, sign, newdB, nb, Ea,na)
else:
  M = int(input("Enter plaintext value: "))
  print("Below is your signature\n")
  sign = encryption(M, newdB, nb)
  print("Below is your Ciphet Text\n")
  CT = encryption(M, Ea, na)
  decryption(CT, sign, newdA, na, Eb,nb)
